...
class ColoredCDBG : public CompactedDBG<DataAccessor<Unitig_data_t>, DataStorage<Unitig_data_t>> {
    ...
    public:
        ...
        */
        bool write(const string& prefix_output_filename, const size_t nb_threads = 1, const bool write_meta_file = true, const bool compress_output = false, const bool verbose = false) const;
