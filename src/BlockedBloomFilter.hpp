...
class BlockedBloomFilter {
    ...
    public:
        ...
        BlockedBloomFilter() : table_(nullptr), blocks_(0), k_(0), fast_div_() {}

        BlockedBloomFilter(size_t nb_elem, size_t bits_per_elem) : table_(nullptr), blocks_(0), k_(0), fast_div_() {
...
class BlockedBloomFilter {
    ...
    public:
        ...
        size_t contains_block(uint64_t kmer_hash, const uint64_t min_hash, const BBF_Blocks blockIDs) const {
    ...
    private:
        ...
        bool insert_par(uint64_t kmer_hash, const uint64_t min_hash) {
        ...
        bool insert_unpar(uint64_t kmer_hash, const uint64_t min_hash) {
