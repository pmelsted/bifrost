...
void CompressedSequence::setSize(const size_t size) {

    if (isShort()) asBits._size = ((0x7F & size) << 1) | 1; // set short flag
...
void CompressedSequence::reserveLength(const size_t new_length) {
